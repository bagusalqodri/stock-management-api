package bsp.stock.api.stock.services;
...
public class StockUpdateService {
    ...
    private void saveToDatabase(JSONObject stock) {
        try {
			...
			stockDTO.setCreatedBy("System");
			stockDTO.setUpdatedBy("System");
			stockDTO.setCreatedDt(LocalDateTime.now());
			stockDTO.setUpdatedDt(LocalDateTime.now());
